...
gtPath = './PPEDNet/Scripts/gt'; % path to your ground truth images
predPath = './PPEDNet/Scripts/predictions'; %path to your predictions (you get them after you implement saving images in the test_segmentation_camvid.py script - or you write your own)
